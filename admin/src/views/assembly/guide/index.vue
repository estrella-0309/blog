<template>
	<div style="height: 80vh;background-color: #ffffff;">
		<el-button type="primary" :icon="Plus" style="margin:10px 0 10px 10px" @click="addDialogVisible = true">添加分类</el-button>
		<el-table :data="categoryList" style="width: 100%;font-size: 18px;">
			...
			<el-table-column label="操作">
				<template v-slot="scope">
					...
					<el-button  type="danger" slot="reference" :icon="Delete">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
...
import { getCategoryList, newCategory, editCategory } from "@/api/modules/category";
